...
const config = {
  ...
  categorias: [
    ...
    {
      title: 'Capa',
      path: <svg xmlns="http://www.w3.org/2000/svg" width="35.333" height="32.266" viewBox="0 0 35.333 32.266"><g id="Grupo_50" data-name="Grupo 50" transform="translate(-567.5 -127.979)"><circle id="Elipse_3" data-name="Elipse 3" cx="1.458" cy="1.458" r="1.458" transform="translate(583.708 134.708)" fill="#d9d9d9"/><path id="Trazado_16" data-name="Trazado 16" d="M590.75,142.594l-.742-.364a12.77,12.77,0,0,0,2.659-7.179c0-5.45-5.092-7.009-7.831-7.072-2.692.063-7.784,1.622-7.784,7.072a9.669,9.669,0,0,0,.363,2.54l-9.915,4.957v17.7l11.512-4.671,11.81,4.491,12.011-4.276V137.774Zm-5.917-12.615c.239.006,5.834.22,5.834,5.072,0,4.347-4.215,8.487-5.827,9.91-1.6-1.422-5.788-5.552-5.788-9.91C579.052,130.2,584.647,129.985,584.833,129.979Zm-7,23.915-8.333,3.381v-13.49l8.333-4.167ZM590,157.613l-10.167-3.866V142.429a25.059,25.059,0,0,0,4.391,4.629l.613.481.616-.479a25.166,25.166,0,0,0,3.3-3.219l1.25.613Zm10.833-3.235L592,157.523V144.249l8.833-3.523Z" fill="#d9d9d9"/></g></svg>,
      component: Visualize
    },
    {
      title: 'Explorar',
      path: <svg xmlns="http://www.w3.org/2000/svg" width="29.33" height="29.33" viewBox="0 0 29.33 29.33"><g id="Grupo_49" data-name="Grupo 49" transform="translate(-638.167 -130.25)"><circle id="Elipse_2" data-name="Elipse 2" cx="1.458" cy="1.458" r="1.458" transform="translate(651.374 143.606)" fill="#d9d9d9"/><g id="Grupo_46" data-name="Grupo 46" transform="translate(638.167 130.25)"><path id="Trazado_14" data-name="Trazado 14" d="M652.832,159.58A14.665,14.665,0,1,1,667.5,144.915,14.681,14.681,0,0,1,652.832,159.58Zm0-27.516a12.851,12.851,0,1,0,12.851,12.851A12.865,12.865,0,0,0,652.832,132.064Z" transform="translate(-638.167 -130.25)" fill="#d9d9d9"/></g><g id="Grupo_47" data-name="Grupo 47" transform="translate(644.613 136.984)"><path id="Trazado_15" data-name="Trazado 15" d="M647.083,154.5a1,1,0,0,1-.94-1.34l3.917-10.833a1,1,0,0,1,.645-.616l10.25-3.167a1,1,0,0,1,1.252,1.245l-3.167,10.5a1,1,0,0,1-.654.664l-11,3.5A.987.987,0,0,1,647.083,154.5Zm4.688-11.025-3.058,8.457,8.564-2.725,2.473-8.2Z" transform="translate(-646.083 -138.5)" fill="#d9d9d9"/></g></g></svg>,
      component: Visualize
    },
    {
      title: 'Contacto',
      path: <svg xmlns="http://www.w3.org/2000/svg" width="19.547" height="20.787" viewBox="0 0 19.547 20.787"> <g id="Grupo_48" data-name="Grupo 48" transform="translate(-51.076 -679.996)"><line id="Línea_4" data-name="Línea 4" x1="9.202" transform="translate(56.248 686.855)" fill="none" stroke="#a8a8a8" stroke-linecap="round" stroke-miterlimit="10" stroke-width="1.688"/><line id="Línea_5" data-name="Línea 5" x1="9.202" transform="translate(56.248 690.654)" fill="none" stroke="#a8a8a8" stroke-linecap="round" stroke-miterlimit="10" stroke-width="1.688"/><path id="Trazado_12" data-name="Trazado 12" d="M51.919,699.94l5.791-4.186H69.779V680.84H51.919Z" fill="none" stroke="#a8a8a8" stroke-linejoin="round" stroke-miterlimit="10" stroke-width="1.688"/></g></svg>
    ,
      component: Visualize
    }
  ]
