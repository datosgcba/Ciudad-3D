 ...
 grupos: [   
    {
      ...
      layers:[
        ...
        { id:"homicidio_segvial", title:"Homocidio Seg Vial", type:"vectortile",           
          displayPopup:true,
          popupContent:templateDelitos,
          options:{            
            "source": {
        ...
        { id:"hurto_automotor", title:"Hurto Automotor", type:"vectortile",          
          displayPopup:true,
          popupContent:templateDelitos,
          options:{            
            "source": {
        ...
        { id:"hurto_sin_violencia", title:"Hurto Sin Violencia", type:"vectortile",           
          displayPopup:true,
          popupContent:templateDelitos,
          options:{            
            "source": {
        ...
        { id:"lesiones_segvial", title:"Lesiones Seg Vial", type:"vectortile",           
          displayPopup:true,
          popupContent:templateDelitos,
          options:{            
            "source": {
        ...
        { id:"robo_automotor", title:"Robo Automotor", type:"vectortile",           
          displayPopup:true,
          popupContent:templateDelitos,
          options:{            
            "source": {
        ...
        { id:"robo_con_violencia", title:"Robo Con Violencia", type:"vectortile",           
          displayPopup:true,
          popupContent:templateDelitos,
          options:{            
            "source": {
    ...
    },
    {
      ...
      expanded:false,
      layers:[
        { id:"edificios", title:"Edificios", type:"vectortile",  
          displayPopup:true,
     ...
     },
    {
      ...
      expanded:false,
      layers:[
        { id:"anillo_digital_lpr", title:"Anillo digital lpr", type:"vectortile", 
          displayPopup:true,
          popupContent:'{camara}',
          options:{            
            "source": {
        ...
        { id:"camaras_cmu", title:"Cámaras cmu", type:"vectortile", 
          displayPopup:true,
          popupContent:'{id}',
          options:{            
            "source": {
        ...
        { id:"camaras_transferidas_de_PFA", title:"Cámaras transferidas de PFA", type:"vectortile", 
          displayPopup:true,
          popupContent:'{id}',
          options:{            
            "source": {
        ...
        { id:"camara_tren_alerta_pfa", title:"Cámara tren alerta PFA", type:"vectortile", 
          displayPopup:true,
          popupContent:'{id}',
          options:{            
            "source": {
    ...
    },
    {
      ...
      layers:[
        ...
        { id:"senderos_seguros", title:"Senderos Seguros", type:"vectortile", 
          displayPopup:true,
          popupContent:'{nombre}',
          options:{            
            "source": {
